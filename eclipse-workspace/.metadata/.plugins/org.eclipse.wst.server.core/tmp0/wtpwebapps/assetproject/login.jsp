            ...
            <div class="card-body ">
                ...
                <form action="./login" method="POST" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="" placeholder="Enter a user name">
                    </div>
				...
				<div class="form-check">
 					   <input type="checkbox" class="form-check-input" value="rememberme">
 					   <label class="form-check-label" for="materialUnchecked">Remember Me</label>
				</div>
				<br>
                  <div class="form-group" >
                  <input type="radio" value="manger" >Manger
